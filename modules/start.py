...
def starter(modules_lst:list):
    ...
    print(f"    [{pink}Imported {len(before_accounts)} Accounts{reset}]")
    if duplicates != 0:
    ...
    print(f"    [{pink}Pick Proxy File{reset}]")
    sleep(1)
    ...
    print(f"    [{pink}Imported {len(before_proxies)} Proxies{reset}]")
    if duplicates != 0:
        print(f"    [{pink}Removed {duplicates} Duplicates{reset}]")
    sleep(1)
    ...
    print("\n\n")
    print(f"    [{pink}Finished Checking{reset}]")
