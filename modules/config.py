...
def change(option:str):
    ...
    if option == "proxy_type":
        ...
        print(f"    [{pink}Pick proxy timeout{reset}]")
        print("\n")
        try:
            timeout = int(input(f"    [{pink}>{reset}] "))
        ...
        print(f"    [{pink}Pick check retries{reset}]")
        print("\n")
        try:
            retries = int(input(f"    [{pink}>{reset}] "))
            if retries <= 0:
                retries = 1
        ...
        print(f"    [{pink}Pick ammount of threads{reset}]")
        print("\n")
        try:
            threads = int(input(f"    [{pink}>{reset}] "))
